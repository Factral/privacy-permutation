...
class VGG_permuted(nn.Module):
    ...
    def __init__(self, initial_perm, batch, num_class=100):
        ...
        self.offset_1, perm_1 = utils.calculate_offset(32, 1, 1, 3, initial_perm, batch)
        self.bcn1 = nn.BatchNorm2d(64)
        self.conv2 =  DeformConv2d(64, 64, 3, padding=1)
        self.offset_2, perm_2 = utils.calculate_offset(self.offset_1.shape[-1], 1, 1, 3, perm_1, batch)
        self.bcn2 = nn.BatchNorm2d(64)
        self.pool1 = utils.DeformMaxPool2d(self.offset_2.shape[-1], perm_2, 2)
        
        # conv2
        self.conv3 = DeformConv2d(64, 128, 3, padding=1)
        self.offset_3, perm_3 = utils.calculate_offset(16, 1, 1, 3, self.pool1.new_perm, batch)
        self.bcn3 = nn.BatchNorm2d(128)
        self.conv4 = DeformConv2d(128, 128, 3, padding=1)
        self.offset_4, perm_4 = utils.calculate_offset(self.offset_3.shape[-1], 1, 1, 3, perm_3, batch)
        self.bcn4 = nn.BatchNorm2d(128)
        self.pool2 = utils.DeformMaxPool2d(self.offset_4.shape[-1], perm_4, 2)

        # conv3
        self.conv5 = DeformConv2d(128, 256, 3, padding=1)
        self.offset_5, perm_5 = utils.calculate_offset(8, 1, 1, 3,  self.pool2.new_perm, batch)
        self.bcn5 = nn.BatchNorm2d(256)
        self.conv6 = DeformConv2d(256, 256, 3, padding=1)
        self.offset_6, perm_6 = utils.calculate_offset(self.offset_5.shape[-1], 1, 1, 3, perm_5, batch)
        self.bcn6 = nn.BatchNorm2d(256)
        self.conv7 = DeformConv2d(256, 256, 3, padding=1)
        self.offset_7, perm_7 = utils.calculate_offset(self.offset_6.shape[-1], 1, 1, 3, perm_6, batch)
        self.bcn7 = nn.BatchNorm2d(256)
        self.pool3 = utils.DeformMaxPool2d(self.offset_7.shape[-1], perm_7, 2)


        # conv4
        self.conv8 = DeformConv2d(256, 512, 3, padding=1)
        self.offset_8, perm_8 = utils.calculate_offset(4, 1, 1, 3, self.pool3.new_perm, batch)
        self.bcn8 = nn.BatchNorm2d(512)
        self.conv9 = DeformConv2d(512, 512, 3, padding=1)
        self.offset_9, perm_9 = utils.calculate_offset(self.offset_8.shape[-1], 1, 1, 3, perm_8, batch)
        self.bcn9 = nn.BatchNorm2d(512)
        self.conv10 = DeformConv2d(512, 512, 3, padding=1)
        self.offset_10, perm_10 = utils.calculate_offset(self.offset_9.shape[-1], 1, 1, 3, perm_9, batch)
        self.bcn10 = nn.BatchNorm2d(512)
        self.pool4 = utils.DeformMaxPool2d(self.offset_10.shape[-1], perm_10, 2)

        # conv5
        self.conv11 = DeformConv2d(512, 512, 3, padding=1)
        self.offset_11, perm_11 = utils.calculate_offset(2, 1, 1, 3,  self.pool4.new_perm, batch)
        self.bcn11 = nn.BatchNorm2d(512)
        self.conv12 = DeformConv2d(512, 512, 3, padding=1)
        self.offset_12, perm_12 = utils.calculate_offset(self.offset_11.shape[-1], 1, 1, 3, perm_11, batch)
